...
function createData(index, id, ngayTaiLen, tieuDe, moTa, nguoiTao, file, type) {
  return {
    index,
    id,
    ngayTaiLen,
...
const rows = DocumentFormMock.map((data, index) =>
  createData(
    index,
    data.id,
    data.ngayTaiLen,
